...
int  FISVSweep_Sync3(graph_t *graph, 
...
// Correction based on Triple Modular Algorithm
{
    ...
    do
    {
        ...
        do 
        {
            ...
            FISVSweep_Sync3(graph, lp_state_prev, lp_state_A, AFaultArrEdge, AFaultArrCC) ;
            FISVSweep_Sync3(graph, lp_state_prev, lp_state_B, BFaultArrEdge, BFaultArrCC) ;
            FISVSweep_Sync3(graph, lp_state_prev, lp_state_C, CFaultArrEdge, CFaultArrCC) ;
